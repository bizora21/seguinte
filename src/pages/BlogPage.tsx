...
import { SEO, generateBreadcrumbSchema } from '../components/SEO' // SEO Importado
...
const BlogPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Blog LojaRápida | Dicas de E-commerce e Negócios em Moçambique"
        description="Acesse guias, dicas de vendas, tendências de mercado e novidades sobre compras online em Moçambique. Aprenda a vender mais e comprar melhor."
        url="/blog"
