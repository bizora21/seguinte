...
import { ArrowLeft, MessageCircle, Store, Clock } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Converse com os vendedores sobre os produtos</p>
        </div>

        {chats.length === 0 ? (
          <Card><CardContent className="p-12 text-center"><MessageCircle className="w-16 h-16 text-gray-400 mx-auto mb-4" /><h2 className="text-xl font-semibold text-gray-900 mb-2">Nenhuma conversa ainda</h2><p className="text-gray-600 mb-6">Inicie uma conversa com um vendedor a partir da página do produto.</p><Button onClick={() => navigate('/')}>Explorar Produtos</Button></CardContent></Card>
        ) : (
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center"><Store className="w-6 h-6 text-green-600" /></div>
                      <div>
                        <h3 className="font-semibold text-lg">{chat.seller.store_name || 'Loja'}</h3>
