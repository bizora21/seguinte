...
const CustomerChats = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      supabase.channel('customer-chats').unsubscribe()
    }
  }, [user])
  ...
  const setupRealtimeSubscription = () => {
    ...
    console.log('Realtime subscription set up for customer chats')
  }
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{chat.seller.email}</p>
                        <div className="flex items-center mt-1 text-sm text-gray-500">
                          <Store className="w-3 h-3 mr-1" />
                          Produto: {chat.product.name}
                        </div>
                      </div>
                    </div>
