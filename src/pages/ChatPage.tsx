...
import { ArrowLeft, Send, Package, Star, Shield, Truck, CreditCard, MessageCircle, Clock, AlertTriangle, User, Store } from 'lucide-react'
...
const ChatPage = () => {
  ...
  const setupChat = async () => {
    ...
    try {
      ...
      setError('Erro ao configurar conversa')
    } finally {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h1 className="text-lg font-semibold truncate max-w-[200px] sm:max-w-none">{product.name}</h1>
              </div>
                            ...
                            <div className="flex items-start space-x-2">
                              ...
                              <div className="text-xs text-yellow-800">
                                ...
                                <p className="text-xs text-yellow-800">
                                  Para sua segurança, siga as políticas do site e nunca compartilhe dados pessoais ou de pagamento fora deste chat.
                                </p>
                              </div>
                            </div>
                          </div>
