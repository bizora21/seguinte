    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "LocalBusiness",
          "name": "LojaRápida",
          "description": "O maior marketplace de Moçambique - Compre e venda online em todo o país",
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-5xl font-bold mb-6">
                LojaRápida - O Marketplace de Moçambique
              </h1>
              <p className="text-xl mb-8 opacity-90">
                Compre e venda em todo Moçambique. Entrega rápida e pagamento seguro.
              </p>
              ...
              {user ? (
                    ...
                    <CardHeader>
                      ...
                      <CardDescription className="text-green-100">
                        {user.profile?.role === 'vendedor' 
                          ...
                          : 'Descubra produtos incríveis em todo Moçambique'
                        }
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      ...
                      {user.profile?.role === 'vendedor' && (
                        <Button onClick={() => navigate('/adicionar-produto')} className="w-full bg-white text-green-600 hover:bg-gray-100">
                ...
                <motion.div
                  ...
                  className="space-x-4"
                >
                  <Button size="lg" onClick={() => navigate('/register')} className="bg-white text-green-600 hover:bg-gray-100">
                    Começar Agora
                  </Button>
        ...
        <div className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { icon: <Users className="w-8 h-8 text-green-600" />, value: '10K+', label: 'Vendedores' },
                ...
                { icon: <TrendingUp className="w-8 h-8 text-green-600" />, value: '100K+', label: 'Clientes' }
              ].map((stat, index) => (
            ...
            {productsLoading ? (
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  {user?.profile?.role === 'vendedor' && (
                    <Button onClick={() => navigate('/adicionar-produto')} className="bg-green-600 hover:bg-green-700">
                      <Plus className="w-4 h-4 mr-2" />
